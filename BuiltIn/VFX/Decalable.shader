...
Shader "Decalable"
{
	Properties
	{
		...
		_EmissionStr("EmissionStr", Range( 0 , 10)) = 0
		_DecalColorMap("_DecalColorMap", 2D) = "black" {}
		[Toggle(_SKINNED_ON)] _Skinned("Skinned", Float) = 0
		_BaseColor("BaseColor", Color) = (1,1,1,1)
		_NormalMap("NormalMap", 2D) = "bump" {}
		[Toggle(_VERTEXCOLORING_ON)] _VertexColoring("VertexColoring", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _VERTEXCOLORING_ON
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag28_g1 = mul( UNITY_MATRIX_M, float4( inputMesh.positionOS , 0.0 ) ).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag28_g1;
						...
						)
			{
				...
				float3 gammaToLinear19 = FastSRGBToLinear( packedInput.ase_color.rgb );
				float4 appendResult24 = (float4(( (_BaseColor).rgb * gammaToLinear19 ) , ( _BaseColor.a * packedInput.ase_color.a )));
				#ifdef _VERTEXCOLORING_ON
				float4 staticSwitch29 = appendResult24;
				#else
				float4 staticSwitch29 = _BaseColor;
				#endif
				float2 uv_BaseColorMap = packedInput.ase_texcoord5.xy * _BaseColorMap_ST.xy + _BaseColorMap_ST.zw;
				float4 temp_output_1_0_g1 = ( staticSwitch29 * tex2D( _BaseColorMap, uv_BaseColorMap ) );
				float4 color20_g1 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float3 vertexToFrag28_g1 = packedInput.ase_texcoord6.xyz;
				#ifdef _SKINNED_ON
				float3 staticSwitch26_g1 = float3( packedInput.uv1.xy ,  0.0 );
				#else
				float3 staticSwitch26_g1 = vertexToFrag28_g1;
				#endif
				float simplePerlin3D9_g1 = snoise( ( ( staticSwitch26_g1 * float3( 2,2,2 ) ) + float3( 0,0,0 ) ) );
				simplePerlin3D9_g1 = simplePerlin3D9_g1*0.5 + 0.5;
				float temp_output_16_0_g1 = ( ( simplePerlin3D9_g1 - 0.5 ) * 0.5 );
				float temp_output_12_0_g1 = ( tex2D( _DecalColorMap, packedInput.uv1.xy ).r + temp_output_16_0_g1 );
				float lerpResult22_g1 = lerp( ( temp_output_12_0_g1 + temp_output_16_0_g1 ) , 0.7 , 0.8);
				float4 lerpResult19_g1 = lerp( temp_output_1_0_g1 , color20_g1 , ( 1.0 - lerpResult22_g1 ));
				float temp_output_3_0_g12 = ( 0.5 - temp_output_12_0_g1 );
				float temp_output_10_0_g1 = ( 1.0 - saturate( ( temp_output_3_0_g12 / fwidth( temp_output_3_0_g12 ) ) ) );
				float4 lerpResult18_g1 = lerp( temp_output_1_0_g1 , lerpResult19_g1 , temp_output_10_0_g1);
				
				float2 uv_NormalMap = packedInput.ase_texcoord5.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 temp_output_4_0_g1 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 surf_pos107_g13 = ase_worldPos;
				float3 surf_norm107_g13 = normalWS;
				float height107_g13 = simplePerlin3D9_g1;
				...
				float3 lerpResult6_g1 = lerp( temp_output_4_0_g1 , BlendNormal( worldToTangentDir42_g13 , temp_output_4_0_g1 ) , temp_output_10_0_g1);
				float3 normalizeResult33_g1 = normalize( lerpResult6_g1 );
				
				float lerpResult32_g1 = lerp( 0.0 , 1.0 , temp_output_10_0_g1);
				
				float2 uv_MaskMap = packedInput.ase_texcoord5.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				float4 tex2DNode17 = tex2D( _MaskMap, uv_MaskMap );
				
				surfaceDescription.BaseColor = lerpResult18_g1.rgb;
				surfaceDescription.Normal = normalizeResult33_g1;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = lerpResult32_g1;
				...
				surfaceDescription.Emission = ( staticSwitch29 * _EmissionStr ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag28_g1 = mul( UNITY_MATRIX_M, float4( inputMesh.positionOS , 0.0 ) ).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag28_g1;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g1 = ( staticSwitch29 * tex2D( _BaseColorMap, uv_BaseColorMap ) );
				float4 color20_g1 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float3 vertexToFrag28_g1 = packedInput.ase_texcoord3.xyz;
				#ifdef _SKINNED_ON
				float3 staticSwitch26_g1 = float3( packedInput.ase_texcoord2.zw ,  0.0 );
				#else
				float3 staticSwitch26_g1 = vertexToFrag28_g1;
				#endif
				float simplePerlin3D9_g1 = snoise( ( ( staticSwitch26_g1 * float3( 2,2,2 ) ) + float3( 0,0,0 ) ) );
				simplePerlin3D9_g1 = simplePerlin3D9_g1*0.5 + 0.5;
				float temp_output_16_0_g1 = ( ( simplePerlin3D9_g1 - 0.5 ) * 0.5 );
				float temp_output_12_0_g1 = ( tex2D( _DecalColorMap, packedInput.ase_texcoord2.zw ).r + temp_output_16_0_g1 );
				float lerpResult22_g1 = lerp( ( temp_output_12_0_g1 + temp_output_16_0_g1 ) , 0.7 , 0.8);
				float4 lerpResult19_g1 = lerp( temp_output_1_0_g1 , color20_g1 , ( 1.0 - lerpResult22_g1 ));
				float temp_output_3_0_g12 = ( 0.5 - temp_output_12_0_g1 );
				float temp_output_10_0_g1 = ( 1.0 - saturate( ( temp_output_3_0_g12 / fwidth( temp_output_3_0_g12 ) ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag28_g1 = mul( UNITY_MATRIX_M, float4( inputMesh.positionOS , 0.0 ) ).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag28_g1;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
					...
					)
			{
				...
				float3 surf_pos107_g13 = ase_worldPos;
				float3 surf_norm107_g13 = normalWS;
				float3 vertexToFrag28_g1 = packedInput.ase_texcoord4.xyz;
				#ifdef _SKINNED_ON
				float3 staticSwitch26_g1 = float3( packedInput.ase_texcoord3.zw ,  0.0 );
				#else
				float3 staticSwitch26_g1 = vertexToFrag28_g1;
				#endif
				float simplePerlin3D9_g1 = snoise( ( ( staticSwitch26_g1 * float3( 2,2,2 ) ) + float3( 0,0,0 ) ) );
				...
				float3 worldToTangentDir42_g13 = mul( ase_worldToTangent, localPerturbNormal107_g13);
				float temp_output_16_0_g1 = ( ( simplePerlin3D9_g1 - 0.5 ) * 0.5 );
				float temp_output_12_0_g1 = ( tex2D( _DecalColorMap, packedInput.ase_texcoord3.zw ).r + temp_output_16_0_g1 );
				float temp_output_3_0_g12 = ( 0.5 - temp_output_12_0_g1 );
				float temp_output_10_0_g1 = ( 1.0 - saturate( ( temp_output_3_0_g12 / fwidth( temp_output_3_0_g12 ) ) ) );
				float3 lerpResult6_g1 = lerp( temp_output_4_0_g1 , BlendNormal( worldToTangentDir42_g13 , temp_output_4_0_g1 ) , temp_output_10_0_g1);
				float3 normalizeResult33_g1 = normalize( lerpResult6_g1 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				_TimeParameters.xyz = timeParameters;
				float3 vertexToFrag28_g1 = mul( UNITY_MATRIX_M, float4( inputMesh.positionOS , 0.0 ) ).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag28_g1;
						...
						)
			{
				...
				float4 temp_output_1_0_g1 = ( staticSwitch29 * tex2D( _BaseColorMap, uv_BaseColorMap ) );
				float4 color20_g1 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float3 vertexToFrag28_g1 = packedInput.ase_texcoord8.xyz;
				#ifdef _SKINNED_ON
				float3 staticSwitch26_g1 = float3( packedInput.uv1.xy ,  0.0 );
				#else
				float3 staticSwitch26_g1 = vertexToFrag28_g1;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-716.3803,-46.45137;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;14;-463.6285,12.8014;Inherit;False;ApplyDecals;2;;1;f7da7b34ea6e39744bbdb4ce1b63d517;0;2;1;FLOAT4;1,1,1,1;False;4;FLOAT3;0,0,1;False;3;COLOR;0;FLOAT;3;FLOAT3;5
Node;AmplifyShaderEditor.SwizzleNode;23;-1514.645,-489.5761;Inherit;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;24;-1047.874,-476.6447;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-1322.191,-492.5165;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GammaToLinearNode;19;-1740.511,-272.273;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexColorNode;18;-1986.831,-279.1748;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-1332.554,-320.0807;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-1904.496,-531.3534;Inherit;False;Property;_BaseColor;BaseColor;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;29;-826.314,-595.5229;Inherit;False;Property;_VertexColoring;VertexColoring;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;-1110.122,-208.2237;Inherit;True;Property;_BaseColorMap;BaseColorMap;0;0;Create;True;0;0;0;False;0;False;-1;None;168750b054ebe3e41bc664af8bce11ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1895.329,80.09622;Inherit;True;Property;_NormalMap;NormalMap;6;0;Create;True;0;0;0;False;0;False;-1;None;de1778e60f5ae344184c55e8211f2158;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-845.8397,225.1246;Inherit;False;Property;_EmissionStr;EmissionStr;1;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-490.103,159.075;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;17;-886.6841,342.2436;Inherit;True;Property;_MaskMap;MaskMap;8;0;Create;True;0;0;0;False;0;False;-1;None;b035aa402f64c7242a561f87b58a8f8d;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
WireConnection;0;0;14;0
WireConnection;0;1;14;5
WireConnection;0;3;14;3
...
ASEEND*/
//CHKSM=81CA9E893AC59DE6F8611297F7E6D2B323EA9D5F