...
Shader "UnderwaterCaustics"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 line_plane_intercept24( float3 lineP, float3 lineN, float3 planeN, float planeD )
			{
						...
						)
			{
				...
				float3 position2_g1 = ase_worldPos;
				float3 normal2_g1 = float3( 0,0,0 );
				float mulTime17 = _TimeParameters.x * _Speed;
				float t2_g1 = mulTime17;
				float sharpness2_g1 = _WaveSharpness;
				float localSumOfGerstnerDirectional2_g1 = SumOfGerstnerDirectional( tiling2_g1 , amplitude2_g1 , detail2_g1 , position2_g1 , normal2_g1 , t2_g1 , sharpness2_g1 );
				float2 spawnExtents2_g2 = _CircleSpawnExtents;
				float2 spawnPosition2_g2 = _CircleSpawnPosition;
				float tiling2_g2 = _Tiling;
				float amplitude2_g2 = _Amplitude;
				int detail2_g2 = 16;
				float3 position2_g2 = ase_worldPos;
				float3 normal2_g2 = float3( 0,0,0 );
				float t2_g2 = mulTime17;
				float sharpness2_g2 = _WaveSharpness;
				float localSumOfGerstnerCircular2_g2 = SumOfGerstnerCircular( spawnExtents2_g2 , spawnPosition2_g2 , tiling2_g2 , amplitude2_g2 , detail2_g2 , position2_g2 , normal2_g2 , t2_g2 , sharpness2_g2 );
				#ifdef _CIRCULARWAVES_ON
				float3 staticSwitch39 = position2_g2;
				#else
				float3 staticSwitch39 = position2_g1;
				#endif
				float3 lineP24 = ( staticSwitch39 - ase_worldPos );
				#ifdef _CIRCULARWAVES_ON
				float3 staticSwitch38 = normal2_g2;
				#else
				float3 staticSwitch38 = normal2_g1;
				#endif
				float3 lineN24 = staticSwitch38;
				float3 planeN24 = float3(0,1,0);
				#ifdef _CIRCULARWAVES_ON
				float staticSwitch40 = localSumOfGerstnerCircular2_g2;
				#else
				float staticSwitch40 = localSumOfGerstnerDirectional2_g1;
				#endif
...
Node;AmplifyShaderEditor.WorldPosInputsNode;21;-2599.377,535.0556;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;20;-2597.338,836.2424;Inherit;False;Property;_Speed;Speed;8;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;17;-2360.021,836.5746;Inherit;False;1;0;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-2417.747,416.0522;Inherit;False;Property;_WaveSharpness;WaveSharpness;5;0;Create;True;0;0;0;False;0;False;0.5;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;35;-2510.752,1275.849;Inherit;False;Property;_CircleSpawnPosition;CircleSpawnPosition;10;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;36;-2518.752,1123.849;Inherit;False;Property;_CircleSpawnExtents;CircleSpawnExtents;7;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;37;-1922.797,1161.254;Inherit;False;SumOfGerstnerCircular;-1;;2;dc2374c520193d74f84dbfa8d8fde39d;0;8;7;FLOAT;0.5;False;1;FLOAT3;0,0,0;False;5;INT;4;False;6;FLOAT;0.2;False;12;FLOAT;1;False;13;FLOAT2;1,1;False;14;FLOAT2;1,1;False;3;FLOAT;0;False;3;FLOAT3;4;FLOAT3;8;FLOAT;10
Node;AmplifyShaderEditor.RangedFloatNode;19;-2292.425,267.8851;Inherit;False;Property;_Amplitude;Amplitude;1;0;Create;True;0;0;0;False;0;False;0.2044121;0.058;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;40;-1210.537,1231.436;Inherit;False;Property;_Keyword1;Keyword 0;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;38;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;27;-832.0334,1130.7;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;38;-1256.461,843.7235;Inherit;False;Property;_CircularWaves;CircularWaves;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;39;-1261.419,1079.679;Inherit;False;Property;_Keyword0;Keyword 0;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;38;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;30;-1534.821,403.0357;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1230.956,1417.543;Inherit;False;Property;_WaterDepth;WaterDepth;9;0;Create;True;0;0;0;False;0;False;0.543;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;24;-1061.423,345.8879;Inherit;False;float distance = (planeD - dot(planeN, lineP)) / dot(lineN, planeN)@$return lineP+lineN * distance@;3;Create;4;True;lineP;FLOAT3;0,0,0;In;;Inherit;False;True;lineN;FLOAT3;0,0,0;In;;Inherit;False;True;planeN;FLOAT3;0,0,0;In;;Inherit;False;True;planeD;FLOAT;0;In;;Inherit;False;line_plane_intercept;True;False;0;;False;4;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SwizzleNode;28;-840.0018,341.961;Inherit;False;FLOAT2;0;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
...
WireConnection;14;6;19;0
WireConnection;14;12;15;0
WireConnection;14;3;17;0
WireConnection;17;0;20;0
WireConnection;37;7;16;0
WireConnection;37;1;21;0
WireConnection;37;5;18;0
WireConnection;37;6;19;0
WireConnection;37;12;15;0
WireConnection;37;13;36;0
WireConnection;37;14;35;0
WireConnection;37;3;17;0
WireConnection;40;1;14;10
WireConnection;40;0;37;10
WireConnection;27;0;40;0
WireConnection;27;1;26;0
WireConnection;38;1;14;4
WireConnection;38;0;37;4
WireConnection;39;1;14;8
WireConnection;39;0;37;8
