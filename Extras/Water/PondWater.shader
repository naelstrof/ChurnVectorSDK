	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 spawnExtents2_g26 = _CircleSpawnExtents;
				float2 spawnPosition2_g26 = _CircleSpawnPosition;
				float tiling2_g26 = _Tiling;
				float amplitude2_g26 = _Amplitude;
				int detail2_g26 = 16;
				float3 position2_g26 = inputMesh.positionOS;
				float3 normal2_g26 = float3( 0,0,0 );
				float mulTime13 = _TimeParameters.x * _Speed;
				float t2_g26 = mulTime13;
				float sharpness2_g26 = _WaveSharpness;
				float localSumOfGerstnerCircular2_g26 = SumOfGerstnerCircular( spawnExtents2_g26 , spawnPosition2_g26 , tiling2_g26 , amplitude2_g26 , detail2_g26 , position2_g26 , normal2_g26 , t2_g26 , sharpness2_g26 );
				...
				#endif
				float3 vertexValue = position2_g26;
						...
						)
			{
				...
				float4 break142 = tex2D( _WaterTexture, uv_WaterTexture );
				float2 spawnExtents2_g26 = _CircleSpawnExtents;
				float2 spawnPosition2_g26 = _CircleSpawnPosition;
				float tiling2_g26 = _Tiling;
				float amplitude2_g26 = _Amplitude;
				int detail2_g26 = 16;
				float3 position2_g26 = packedInput.ase_texcoord6.xyz;
				float3 normal2_g26 = float3( 0,0,0 );
				float mulTime13 = _TimeParameters.x * _Speed;
				float t2_g26 = mulTime13;
				float sharpness2_g26 = _WaveSharpness;
				float localSumOfGerstnerCircular2_g26 = SumOfGerstnerCircular( spawnExtents2_g26 , spawnPosition2_g26 , tiling2_g26 , amplitude2_g26 , detail2_g26 , position2_g26 , normal2_g26 , t2_g26 , sharpness2_g26 );
				float4 appendResult15_g26 = (float4(normal2_g26 , 0.0));
				float3 temp_output_133_4 = (mul( GetObjectToWorldMatrix(), appendResult15_g26 )).xyz;
				float fresnelNdotV153 = dot( normalize( temp_output_133_4 ), V );
				float fresnelNode153 = ( 0.1 + 3.0 * pow( 1.0 - fresnelNdotV153, 4.0 ) );
				float4 appendResult143 = (float4(break142.r , break142.g , break142.b , ( break142.a * saturate( fresnelNode153 ) )));
				float2 uv_Foam = packedInput.ase_texcoord5.xy * _Foam_ST.xy + _Foam_ST.zw;
				float2 panner146 = ( 1.0 * _Time.y * float2( -0.032,-0.032 ) + uv_Foam);
				float temp_output_157_0 = (0.0 + (localSumOfGerstnerCircular2_g26 - -_Amplitude) * (1.0 - 0.0) / (_Amplitude - -_Amplitude));
				float temp_output_138_0 = ( tex2D( _Foam, panner146 ).r * saturate( temp_output_157_0 ) * _FoamColor.a );
				float4 lerpResult151 = lerp( appendResult143 , _FoamColor , temp_output_138_0);
				...
				float fresnelNdotV76 = dot( normalize( temp_output_133_4 ), V );
				float fresnelNode76 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV76, 5.0 ) );
				float4 lerpResult82 = lerp( float4( 0,0,0,0 ) , _TransmissionColor , ( saturate( fresnelNode76 ) * temp_output_157_0 ));
				
				float lerpResult137 = lerp( 0.95 , 0.25 , temp_output_138_0);
				
				surfaceDescription.BaseColor = lerpResult151.rgb;
				surfaceDescription.Normal = mul( ase_worldToTangent, temp_output_133_4 );
				...
				surfaceDescription.Smoothness = lerpResult137;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = lerpResult151.a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float amplitude2_g26 = _Amplitude;
				int detail2_g26 = 16;
				float3 position2_g26 = packedInput.ase_texcoord4.xyz;
				float3 normal2_g26 = float3( 0,0,0 );
				float mulTime13 = _TimeParameters.x * _Speed;
				float t2_g26 = mulTime13;
				float sharpness2_g26 = _WaveSharpness;
				...
				float4 appendResult15_g26 = (float4(normal2_g26 , 0.0));
				float3 temp_output_133_4 = (mul( GetObjectToWorldMatrix(), appendResult15_g26 )).xyz;
				float fresnelNdotV153 = dot( normalize( temp_output_133_4 ), ase_worldViewDir );
				float fresnelNode153 = ( 0.1 + 3.0 * pow( 1.0 - fresnelNdotV153, 4.0 ) );
				float4 appendResult143 = (float4(break142.r , break142.g , break142.b , ( break142.a * saturate( fresnelNode153 ) )));
				...
				float fresnelNdotV76 = dot( normalize( temp_output_133_4 ), ase_worldViewDir );
				float fresnelNode76 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV76, 5.0 ) );
				float4 lerpResult82 = lerp( float4( 0,0,0,0 ) , _TransmissionColor , ( saturate( fresnelNode76 ) * temp_output_157_0 ));
		...
		Pass
		{
					...
					)
			{
				...
				float amplitude2_g26 = _Amplitude;
				int detail2_g26 = 16;
				float3 position2_g26 = packedInput.ase_texcoord2.xyz;
				float3 normal2_g26 = float3( 0,0,0 );
				float mulTime13 = _TimeParameters.x * _Speed;
				float t2_g26 = mulTime13;
				float sharpness2_g26 = _WaveSharpness;
		...
		Pass
		{
						...
						)
			{
				...
				float amplitude2_g26 = _Amplitude;
				int detail2_g26 = 16;
				float3 position2_g26 = packedInput.ase_texcoord8.xyz;
				float3 normal2_g26 = float3( 0,0,0 );
				float mulTime13 = _TimeParameters.x * _Speed;
				float t2_g26 = mulTime13;
				float sharpness2_g26 = _WaveSharpness;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;118;235.0984,-75.93423;Inherit;False;2;2;0;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldToTangentMatrix;78;-53.89573,-113.1374;Inherit;False;0;1;FLOAT3x3;0
Node;AmplifyShaderEditor.ColorNode;83;-292.7371,-501.7617;Inherit;False;Property;_TransmissionColor;TransmissionColor;1;0;Create;True;0;0;0;False;0;False;0.3820755,1,0.9364549,1;0.7169812,0.7169812,0.7169812,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;82;41.2435,-275.2557;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;77;-915.2678,-276.8021;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;63;-1276.142,-28.00772;Inherit;False;Property;_Amplitude;Amplitude;0;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-1355.587,191.0554;Inherit;False;Property;_WaveSharpness;WaveSharpness;4;0;Create;True;0;0;0;False;0;False;0.5;2.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;101;-1464.626,271.2133;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;127;-1326.107,897.0512;Inherit;False;Property;_CircleSpawnPosition;CircleSpawnPosition;7;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;126;-1334.107,745.0512;Inherit;False;Property;_CircleSpawnExtents;CircleSpawnExtents;5;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;97;-1399.628,522.2085;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;1;32;0;16;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;133;-874.417,331.0301;Inherit;False;SumOfGerstnerCircular;-1;;26;dc2374c520193d74f84dbfa8d8fde39d;0;8;7;FLOAT;0.5;False;1;FLOAT3;0,0,0;False;5;INT;4;False;6;FLOAT;0.2;False;12;FLOAT;1;False;13;FLOAT2;1,1;False;14;FLOAT2;1,1;False;3;FLOAT;0;False;3;FLOAT3;4;FLOAT3;8;FLOAT;10
Node;AmplifyShaderEditor.IntNode;60;-1299.741,413.0923;Inherit;False;Constant;_Detail;Detail;1;0;Create;True;0;0;0;False;0;False;16;16;True;0;1;INT;0
Node;AmplifyShaderEditor.SimpleTimeNode;13;-1368.86,651.578;Inherit;False;1;0;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;139;-124.4248,-1589.726;Inherit;True;Property;_WaterTextureSample;WaterTextureSample;5;0;Create;True;0;0;0;False;0;False;-1;e793edb4a59e4374a88f62a166569c48;200a165fa467df44083105be5846b496;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;140;-465.3669,-1023.923;Inherit;True;Property;_WaterTextureSample1;WaterTextureSample;5;0;Create;True;0;0;0;False;0;False;-1;e793edb4a59e4374a88f62a166569c48;200a165fa467df44083105be5846b496;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;141;117.4821,-899.9694;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.BreakToComponentsNode;142;251.9652,-1535.37;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.DynamicAppendNode;143;438.3087,-1513.552;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.BreakToComponentsNode;144;665.5585,-864.16;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;145;315.6372,-1373.219;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;146;-747.8594,-1132.148;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.032,-0.032;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;147;-1039.777,-1241.869;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;148;-1325.96,-1096.827;Inherit;True;Property;_Foam;Foam;8;0;Create;True;0;0;0;False;0;False;7fa60e7d307e45b44b9c081b16162c3d;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;149;-790.798,-1631.105;Inherit;True;Property;_WaterTexture;WaterTexture;6;0;Create;True;0;0;0;False;0;False;4a1ef29df10dfc7469e650d7aa54eb52;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;150;-473.5772,-1703.846;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;151;441.3836,-1062.474;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;152;-371.1491,-1327.15;Inherit;False;Property;_FoamColor;FoamColor;10;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;138;260.5655,-665.1746;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;76;-597.9999,-321.3516;Inherit;False;Standard;WorldNormal;ViewDir;True;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;153;-534.6201,106.8268;Inherit;False;Standard;WorldNormal;ViewDir;True;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0.1;False;2;FLOAT;3;False;3;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;154;-273.6201,36.82675;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;155;-384.6201,-294.1732;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;156;-966.7112,2.736206;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;157;-757.6471,-54.05386;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;158;-500.1788,-55.48108;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;137;398.877,-391.7854;Inherit;False;3;0;FLOAT;0.95;False;1;FLOAT;0.25;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;329.4379,157.8128;Inherit;False;Property;_RefractionIndex;RefractionIndex;2;0;Create;True;0;0;0;False;0;False;1;0;0.95;1.05;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;159;-1573.46,691.5588;Inherit;False;Property;_Speed;Speed;9;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
WireConnection;0;0;151;0
WireConnection;0;1;118;0
WireConnection;0;6;82;0
WireConnection;0;7;137;0
WireConnection;0;9;144;3
WireConnection;0;17;64;0
WireConnection;0;11;133;8
WireConnection;118;0;78;0
WireConnection;118;1;133;4
WireConnection;82;1;83;0
WireConnection;82;2;81;0
WireConnection;81;0;155;0
WireConnection;81;1;157;0
WireConnection;133;7;99;0
WireConnection;133;1;101;0
WireConnection;133;5;60;0
WireConnection;133;6;63;0
WireConnection;133;12;97;0
WireConnection;133;13;126;0
WireConnection;133;14;127;0
WireConnection;133;3;13;0
WireConnection;13;0;159;0
WireConnection;139;0;149;0
WireConnection;139;1;150;0
WireConnection;139;7;149;1
WireConnection;140;0;148;0
WireConnection;140;1;146;0
WireConnection;140;7;148;1
...
WireConnection;151;2;138;0
WireConnection;138;0;141;0
WireConnection;138;1;158;0
WireConnection;138;2;152;4
WireConnection;76;0;133;4
WireConnection;76;4;77;0
WireConnection;153;0;133;4
WireConnection;153;4;77;0
WireConnection;154;0;153;0
WireConnection;155;0;76;0
WireConnection;156;0;63;0
WireConnection;157;0;133;10
WireConnection;157;1;156;0
WireConnection;157;2;63;0
WireConnection;158;0;157;0
WireConnection;137;2;138;0
ASEEND*/
//CHKSM=96BF42D6504E329B6D2F9179E2675B61796768E6